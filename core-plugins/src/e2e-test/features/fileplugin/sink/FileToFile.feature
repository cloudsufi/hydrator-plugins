...
#    Then Validate output file generated by file sink plugin is equal to expected output file "<ExpectedOutputFile>"
  ...
  Scenario: To verify data is getting transferred from File to File sink successfully for delimited format
    ...
    Then Close the pipeline logs
    Then Validate OUT record count is equal to IN record count
#    Then Validate output file generated by file sink plugin is equal to expected output file "outputForCSVDelimitedOutputTest"
  ...
  Scenario: To verify data is getting transferred from File to File successfully with file sink properties as macro arguments
    ...
    Then Navigate to the properties page of plugin: "File2"
    Then Enter input plugin property: "referenceName" with value: "FileReferenceName"
    Then Click on the Macro button of Property: "path" and set the value to: "fileSinkTargetBucket"
    ...
    Then Save the pipeline
    Then Preview and run the pipeline
    Then Enter runtime argument value "filePluginOutputFolder" for key "fileSinkTargetBucket"
