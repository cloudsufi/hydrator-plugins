...
Feature: Normalize transform - Verify File source data transfer using Normalize transformation
  ...
  Scenario: To verify data is getting transferred from File source to File sink successfully with Normalized fields
    ...
    Then Close the pipeline logs
#    Then Validate output file generated by file sink plugin is equal to expected output file "normalizeCsvAllDataTypeOutputFile"
  ...
  Scenario: To verify data is getting transferred from File source to File sink successfully with different Normalized fields
    ...
    Then Verify the pipeline status is "Succeeded"
    Then Close the pipeline logs
#    Then Validate output file generated by file sink plugin is equal to expected output file "normalizeCsvOutputFile"
