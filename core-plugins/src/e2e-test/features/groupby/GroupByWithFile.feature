...
Feature: GroupBy - Verify File source to File sink data transfer using GroupBy analytics
  ...
  @GROUP_BY_TEST @FILE_SINK_TEST
  Scenario: To verify complete flow of data extract and transfer from File source to File sink with GroupBy plugin using first,last,longestString,shortestString,countNulls aggregates
    Given Open Datafusion Project to configure pipeline
    When Select plugin: "File" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Analytics"
    When Select plugin: "Group By" from the plugins list as: "Analytics"
    ...
    Then Select dropdown plugin property: "groupByFields" with option value: "groupByValidSecondField"
    Then Press ESC key to close the unique fields dropdown
    Then Select dropdown plugin property: "groupByFields" with option value: "groupByValidThirdField"
    Then Press ESC key to close the unique fields dropdown
    Then Enter GroupBy plugin Fields to be Aggregate "groupBySet1Aggregates"
    Then Click on the Get Schema button
    Then Click on the Validate button
    Then Close the Plugin Properties page
    Then Navigate to the properties page of plugin: "File2"
    ...
    Then Close the pipeline logs
    Then Validate OUT record count of groupby is equal to IN record count of sink
    Then Validate output file generated by file sink plugin "fileSinkTargetBucket" is equal to expected output file "groupByTest8OutputFile"

  @GROUP_BY_TEST @FILE_SINK_TEST
  Scenario: To verify complete flow of data extract and transfer from File source to File sink with GroupBy plugin using sumOfSquaresIf,correctedSumOfSquaresIf,sumOfSquares,correctedSumOfSquares aggregates
    Given Open Datafusion Project to configure pipeline
    When Select plugin: "File" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Analytics"
    When Select plugin: "Group By" from the plugins list as: "Analytics"
    ...
    Then Select dropdown plugin property: "groupByFields" with option value: "groupByValidThirdField"
    Then Press ESC key to close the unique fields dropdown
    Then Enter GroupBy plugin Fields to be Aggregate "groupBySet2Aggregates"
    Then Click on the Get Schema button
    Then Click on the Validate button
    Then Close the Plugin Properties page
    Then Navigate to the properties page of plugin: "File2"
    ...
    Then Close the pipeline logs
    Then Validate OUT record count of groupby is equal to IN record count of sink
    Then Validate output file generated by file sink plugin "fileSinkTargetBucket" is equal to expected output file "groupByTest9OutputFile"

  @GROUPBY_TEST @FILE_SINK_TEST
  Scenario: To verify complete flow of data extract and transfer from File source to File sink with GroupBy plugin using collectList,collectSet,collectListIf,collectSetIf aggregates
    Given Open Datafusion Project to configure pipeline
    When Select plugin: "File" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Analytics"
    When Select plugin: "Group By" from the plugins list as: "Analytics"
    ...
    Then Click plugin property: "skipHeader"
    Then Click on the Get Schema button
    Then Verify the Output Schema matches the Expected Schema: "groupByCsvTestFileSchema"
    Then Validate "File" plugin properties
    Then Close the Plugin Properties page
    Then Navigate to the properties page of plugin: "Group By"
    Then Select dropdown plugin property: "groupByFields" with option value: "groupByField"
    Then Press ESC key to close the unique fields dropdown
    Then Enter GroupBy plugin Fields to be Aggregate "groupBySet3Aggregates"
    Then Click on the Get Schema button
    Then Click on the Validate button
    Then Close the Plugin Properties page
    Then Navigate to the properties page of plugin: "File2"
    ...
    Then Close the pipeline logs
    Then Validate OUT record count of groupby is equal to IN record count of sink
    Then Validate output file generated by file sink plugin "fileSinkTargetBucket" is equal to expected output file "groupByTest10OutputFile"

  @GROUPBY_TEST @FILE_SINK_TEST
  Scenario: To verify complete flow of data extract and transfer from File source to File sink with GroupBy plugin using countDistinctIf,
  longestStringIf,shortestStringIf,concatIf,varianceIf,concatDistinctIf,stdDevIf,logicalAndIf,logicalOrIf,logicalAnd,logicalOr aggregates
    Given Open Datafusion Project to configure pipeline
    When Select plugin: "File" from the plugins list as: "Source"
    When Expand Plugin group in the LHS plugins list: "Analytics"
    When Select plugin: "Group By" from the plugins list as: "Analytics"
    ...
    Then Select dropdown plugin property: "groupByFields" with option value: "groupByField"
    Then Press ESC key to close the unique fields dropdown
    Then Enter GroupBy plugin Fields to be Aggregate "groupBySet4Aggregates"
    Then Click on the Get Schema button
    Then Click on the Validate button
    Then Close the Plugin Properties page
    Then Navigate to the properties page of plugin: "File2"
    ...
    Then Close the pipeline logs
    Then Validate OUT record count of groupby is equal to IN record count of sink
    Then Validate output file generated by file sink plugin "fileSinkTargetBucket" is equal to expected output file "groupByTest11OutputFile"
